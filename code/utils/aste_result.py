...
class Result:
    ...
    def parse_from(cls, all_preds, examples):
        ...
        for preds in all_preds:
            ...
            for (i, a_start, a_end, b_start, b_end, pol) in preds['pair_preds']:
                ...
                # result_json[ID]['pair_preds'].add((b_start, b_end))
    ...
    def save(self, dir_name, args):
        ...
        result_file_name = os.path.join(dir_name, f'{self.monitor*10000:4.0f}.txt')
        performance_file_name = os.path.join('../code/output', f'{args.cuda_ids}.txt')
